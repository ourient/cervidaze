/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/blog/resources/comment-widget-dark/comment-widget.js"></script>
...
const s_formId = '1FAIpQLSdA4OnNgySZKo4o_jDNrxQS1lrh6Aosp6dKHGksIvs7-yzWkQ';
const s_nameId = '1868276373';
const s_websiteId = '1596726141';
const s_textId = '1128503425';
const s_pageId = '1840825484';
const s_replyId = '24285131';
const s_sheetId = '1kNTE_ERHTRvXXAfzm3ykSfBe597bZVtA3iGGNsl6qTQ';
...
const s_maxLength = 1500; // The max character length of a comment
...
const s_filteredWords = [ // Add words to filter by putting them in quotes and separating with commas (ie. 'heck', 'dang')
    `ape-shit`, `apeshit`, `bean-flicker`, `beaner`, `beaners`, `beanflicker`, `chinaman`, `chinamen`, `ching-chong`, `chink`, `chinks`, `chinky`, `coon`, `coons`, `curry-muncher`, `currymuncher`, `dune-coon`, `gook`, `gook-eye`, `gookie`, `gooks`, `gooky`, `jailbait`, `jap`, `negro`, `nigga`, `nigger`, `niggs`, `nignog`, `retard`, `retards`, `retarded` ,`sand-nigger`, `sandnigger`, `she-male`, `shemale`, `slant-eye`, `slanteye`
]
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-nameInput rounded" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}" required>
    </div>
    ...
    <div id="c_websiteWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-websiteInput rounded" name="entry.${s_websiteId}" id="entry.${s_websiteId}" type="url" pattern="https://.*">
    </div>

    <div id="c_textWrapper" class="c-inputWrapper">
        <label class="c-label c-textLabel" for="entry.${s_textId}">${s_textFieldLabel}</label>
        <textarea class="c-input c-textInput rounded" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" required></textarea>
    </div>
