...
<div class="flex">
  <main class="border main--padding">
      ...
      <p>please feel free to <a href="https://github.com/ourient/cervidaze" target="_blank">inspect my site</a> to see how i scrapped everything together if something interests you-<a href="mailto:c3rvidaze.me" target="_blank">my email</a> is also always open for questions.
      </p><br>
      <h2>tools/assets</h2>
      ...
      <p>the header font is <a href="https://craftsupply.co/product/diamend-pixel-font/" target="_blank">diamend pixel</a>, and the body font is <a href="https://www.1001fonts.com/cmu-font.html" target="_blank">computer modern</a>.</p>
      <p>i use <a href="https://coolors.co"
        ...
        <p>whenever possible, i include sources in the file names of my graphics; otherwise, they are sourced from tumblr, pinterest, or neocities sites. images are dithered and compressed with <a href="https://app.dithermark.com/" target="_blank">dithermark</a> and <a href ="https://tinypng.com/" target="_blank">tinypng</a> respectively.</p><br>
      <h2>codes</h2>
      ...
      <br>
      <h2>accessibility</h2>
      <p>my goal is to make cervidaze as comfortable as possible to browse, no matter what device it's pulled from.
        i am someone particularly sensitive to suddenly loud and flashing stimuli, and i try not to
        replicate the same hostile experiences in my own space.</p>
      <p>my site will always be a work in progress, but this is what i have implemented so far:</p>
      <ul class="no-bullets">
        <li>mobile responsiveness</li>
        <li>properly contrasted site colors</li>
        <li>semantic html tagging</li>
        <li>dark mode toggle</li>
        <li>alt text for relevant images</li>
        <li>no auto-playing videos or audio</li>
        <li>static versions of my site button</li>
      </ul>
      <br>
      <h2>i love you</h2>
  </main>
