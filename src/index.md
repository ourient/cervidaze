    ...
    <aside class="short short-mobile narrow border right-side scrollbar order-last">
        ...
        <div class="changelog rounded scrollbar main-background card-background-light">
            <ul class="no-bullets">
                ...
                <li>10/20/25<br>updated /media;<br>updated music playlist</li>
                ...
                <li>8/9/25<br>updated /interests;<br>added lightbox features</li>
                <li>8/5/25<br>new essay;<br>updated /about</li>
                ...
                <li>3/2/25<br>uploaded all posts from previous blog;<br>updated /links;<br>code housekeeping
                </li>
                <li>2/25/25<br>new blog post;<br>added newsletter form;<br>moved contact info to /about</li>
                ...
                <li>1/12/25<br>updated /links</li>
